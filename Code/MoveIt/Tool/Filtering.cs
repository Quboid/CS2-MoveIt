...
namespace MoveIt.Tool
{
    public partial class MIT : ObjectToolBaseSystem
    {
        ...
        internal static bool IsValidBase(EntityManager Manager, Entity e)
        {
            ...
            if (Manager.HasComponent<Game.Objects.Placeholder>(e)) return false;
            if (Manager.HasComponent<Game.Objects.Marker>(e)) return false;
        ...
        private void UpdateMarqueeList(Input.Marquee marquee)
        {
            ...
            for (var i = 0; i < math.min(searcher.Count, MoveIt.Selection.SelectionBase.MAX_SELECTION_SIZE); i++)
            {
        ...
        // internal static bool PointInRectangle(Quad3 rectangle, float x, float z)
        // {
        //     return PointInRectangle(rectangle, new(x, 0f, z));
        // }

        // internal static bool PointInRectangle(Quad3 rectangle, float3 p)
        // {
        ...
        // private static bool IsLeft(float3 p0, float3 p1, float3 p2)
        // {
